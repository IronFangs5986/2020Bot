...
public class ColorSpinner extends Subsystem {
  ...
  /* Call colorSensor defined in RobotMap */
  ...
  public int getColor() {
    ...
    /* Compares R, G, and B values to determine what color the sensor is reading */
  ...
  /* Spins disk at a proper speed for the sensor to read */
